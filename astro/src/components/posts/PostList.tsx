  ...
  if (error) {
    return (
      <motion.div
        ...
        animate={{ opacity: 1, y: 0 }}
        role="alert"
        className="card flex flex-col items-center justify-center gap-3 rounded-lg px-6 py-12 text-center"
      >
        ...
        <button
          ...
          className="focus-ring inline-flex items-center gap-1.5 rounded-lg bg-zinc-700 px-4 py-2 text-sm font-medium text-white transition-colors hover:bg-zinc-800"
        >
  ...
  if (posts.length === 0) {
    return (
      <motion.div
        initial={{ opacity: 0, y: 10 }}
        animate={{ opacity: 1, y: 0 }}
        className="card flex min-h-[22rem] flex-col items-center justify-center rounded-lg px-6 py-16 text-center"
      >
