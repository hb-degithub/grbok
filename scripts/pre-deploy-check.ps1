...
# 1. Git 状态检查
Write-Host "[1/5] Git 状态检查" -ForegroundColor Cyan
...
# 3. Astro 构建验证
Write-Host "[3/5] Astro 构建验证" -ForegroundColor Cyan
...
# 4. 迁移验证 (Linux 环境)
Write-Host "[4/5] 迁移验证 (Linux)" -ForegroundColor Cyan
...
# 5. .env 文件检查
Write-Host "[5/5] .env 文件检查" -ForegroundColor Cyan
